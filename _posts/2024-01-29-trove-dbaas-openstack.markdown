---
title: "Trove DBaaS for Openstack"
layout: post
date: 2024-01-25
image: /assets/images/2024-01-26-trove-dbaas-openstack.markdown/ceph-keystone.png
headerImage: true
tag:
- Ceph
- RGW
...
blog: true
author: Satish Patel
description: "Trove DBaaS for Openstack"
...
Following are my trove mgmt network IPs assigned to VLAN 15 which on DBaaS interface on 3 openstack controller nodes. 
